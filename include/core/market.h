/**
 * @file market.h
 * @brief Real-world currency & market engine
 *
 * Currencies are real ISO codes with fluctuating exchange rates.
 * No fixed "+25 gold" — income is in local currency, value changes
 * with the global market. Player holds a multi-currency wallet.
 */
#ifndef CIV_CORE_MARKET_H
#define CIV_CORE_MARKET_H
