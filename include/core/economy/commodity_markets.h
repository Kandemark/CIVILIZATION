/**
 * @file commodity_markets.h
 * @brief Commodity markets — resource supply, demand, and regional pricing
 */

#ifndef CIV_ECONOMY_COMMODITY_MARKETS_H
#define CIV_ECONOMY_COMMODITY_MARKETS_H
