/**
 * @file international_trade.h
 * @brief International trade — routes, tariffs, trade deals, embargoes
 */

#ifndef CIV_ECONOMY_INTERNATIONAL_TRADE_H
#define CIV_ECONOMY_INTERNATIONAL_TRADE_H
